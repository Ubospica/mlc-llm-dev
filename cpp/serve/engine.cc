  ...
  static Result<EngineCreationOutput> Create(const std::string& engine_config_json_str,
    ...
    if (engine_config->speculative_mode != SpeculativeMode::kDisable) {
      ...
      switch (engine_config->speculative_mode) {
        ...
        default:
          n->actions_ = {
              EngineAction::NewRequestPrefill(n->models_, logit_processor, sampler,
                                              n->model_workspaces_, engine_config, model_configs,
                                              n->trace_recorder_),
      ...
      n->actions_ = {EngineAction::NewRequestPrefill(n->models_, logit_processor, sampler,
                                                     n->model_workspaces_, engine_config,
                                                     model_configs, n->trace_recorder_),
