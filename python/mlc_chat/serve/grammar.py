...
class GrammarStateMatcher(Object):
    ...
    def __init__(self, grammar: BNFGrammar, max_rollback_steps: int = 0):
        self.__init_handle_by_constructor__(_ffi_api.GrammarStateMatcher, grammar, max_rollback_steps)  # type: ignore  # pylint: disable=no-member
    ...
    def accept_char(self, codepoint: int, drop_old: bool = True) -> bool:
        ...
        """
        return _ffi_api.GrammarStateMatcherAcceptChar(  # type: ignore  # pylint: disable=no-member
    ...
    def get_rejected_token_ids_for_tokenizer(
        ...
        return _ffi_api.GrammarStateMatcherGetRejectedTokenIdsForTokenizer(  # type: ignore  # pylint: disable=no-member
