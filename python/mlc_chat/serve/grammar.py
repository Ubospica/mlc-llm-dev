...
class GrammarMatcher(Object):
    ...
    def can_reach_end(self) -> bool:
        ...
        """
        return _ffi_api.GrammarMatcherCanReachEnd(self)  # type: ignore  # pylint: disable=no-member
    ...
    def match_complete_string(self, string: str) -> bool:
        ...
        grammar."""
        return _ffi_api.GrammarMatcherMatchCompleteString(self, string)  # type: ignore  # pylint: disable=no-member
