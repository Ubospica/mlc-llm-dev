...
or_test ::= ("" | (or_test_choice) | ([d] [e]) | (or_test) | ([a-z]))
sequence_test ::= (([a] [a] [b] sequence_test_choice [d] [e] sequence_test))
nested_test ::= (([a] [b] [c] [d]) | (nested_test_choice_1) | (nested_test_choice_4))
empty_test ::= ("" | ([d]) | (empty_test_choice))
or_test_choice ::= (([a]) | ([b]))
sequence_test_choice ::= (([c]) | ([d]))
nested_test_choice ::= (([b]) | ([c]))
nested_test_choice_1 ::= (([a]) | (nested_test_choice))
nested_test_choice_2 ::= (([d]) | ([e] [f]))
nested_test_choice_3 ::= (([b] [c]) | (nested_test_choice_2))
nested_test_choice_4 ::= (([a]) | (nested_test_choice_3))
empty_test_choice ::= ("" | ([a]))
"""
